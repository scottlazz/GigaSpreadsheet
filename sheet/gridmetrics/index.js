export default class Metrics {
    ...
    getColWidth(col) {
        if (col in this.sheet.widthOverrides)
            return this.sheet.widthOverrides[col] * this.sheet.zoomLevel;
        if (col in this.sheet.maxWidthInCol && this.sheet.maxWidthInCol[col].max > this.sheet.cellWidth)
            return this.sheet.maxWidthInCol[col].max * this.sheet.zoomLevel;
    ...
    getHeightOverride(row) {
        if (row in this.sheet.heightOverrides)
            return this.sheet.heightOverrides[row] * this.sheet.zoomLevel;
    }
