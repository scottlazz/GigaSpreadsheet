...
import { dependencyTree, shiftDependenciesDown, shiftDependenciesRight, shiftDependenciesUp, shiftDependenciesLeft, removeDependents } from "../packages/dependencytracker";
...
export default class Sheet {
    constructor(wrapper, options = {}) {
        ...
        this.getMerge = (row, col) => {
            ...
            return this.mergedCells.find((merged) => row >= merged.startRow &&
                row <= merged.endRow &&
                col >= merged.startCol &&
                col <= merged.endCol);
        };
        ...
        this.immediateUpdateDims = () => {
            ...
            for (let col in colsNeedingRemax) {
                ...
                for (let key in cells) {
                    ...
                    if (!this.isNotMergedOver(cell.row, cell.col))
                        continue;
                    if (cell._dims) {
        ...
        // Configuration
        this.cellWidth = (_a = options.cellWidth) !== null && _a !== void 0 ? _a : 64;
        this.cellHeight = (_b = options.cellHeight) !== null && _b !== void 0 ? _b : 20;
        this.blockRows = (_c = options.blockRows) !== null && _c !== void 0 ? _c : 28; // Max rows per canvas block
        this.blockCols = (_d = options.blockCols) !== null && _d !== void 0 ? _d : 30; // Max cols per canvas block
        this.paddingBlocks = (_e = options.paddingBlocks) !== null && _e !== void 0 ? _e : 1; // Extra blocks to render around visible area
        ...
        this.widthMaxByCol = {};
        this.freeze = { col: 4 };
        this.gridlinesOn = (_f = options.gridlinesOn) !== null && _f !== void 0 ? _f : true;
    ...
    initEventListeners() {
        ...
        this.container.addEventListener('contextmenu', (e) => {
            if (e.target.closest('.row-number-container'))
                return;
            if (e.target.closest('.header-container'))
                return;
            if (e.target.closest('.corner-cell'))
                return;
            if (e.target.closest('.cell-edit-input'))
                return;
            e.preventDefault(); // Prevent the default browser context menu
        });
        (_a = this._container.querySelector('.align-button-group')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (e) => {
            var _a;
            // console.log('clicked align buttons', e.target?.getAttribute('data-align'))
            const textAlign = (_a = e.target) === null || _a === void 0 ? void 0 : _a.getAttribute('data-align');
            const selectedCells = this.getSelectedCells();
            this.setCells(selectedCells, 'ta', textAlign);
        });
        (_b = this._container.querySelector('.quick-text-actions-buttons')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', async (e) => {
            var _a;
            // console.log('clicked align buttons', e.target?.getAttribute('data-align'))
            const action = (_a = e.target) === null || _a === void 0 ? void 0 : _a.getAttribute('data-action');
            if (action === 'copy') {
        ...
        (_c = this.toolbar) === null || _c === void 0 ? void 0 : _c.onAction(async (action, value) => {
            ...
            if (action === 'Merge') {
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const value = ((_a = this.getCell(c.row, c.col)) === null || _a === void 0 ? void 0 : _a.ta) || 'left';
                (_b = this.toolbar) === null || _b === void 0 ? void 0 : _b.set('textAlign', value);
            }
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const value = ((_c = this.getCell(c.row, c.col)) === null || _c === void 0 ? void 0 : _c.ta) || 'left';
                (_d = this.toolbar) === null || _d === void 0 ? void 0 : _d.set('textAlign', value);
            }
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const value = ((_e = this.getCell(c.row, c.col)) === null || _e === void 0 ? void 0 : _e.ta) || 'left';
                (_f = this.toolbar) === null || _f === void 0 ? void 0 : _f.set('textAlign', value);
            }
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const fontSize = ((_g = this.getCell(c.row, c.col)) === null || _g === void 0 ? void 0 : _g.fontSize) || '12';
                (_h = this.toolbar) === null || _h === void 0 ? void 0 : _h.set('fontSize', fontSize.toString());
            }
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const fontSize = ((_j = this.getCell(c.row, c.col)) === null || _j === void 0 ? void 0 : _j.fontSize) || '12';
                (_k = this.toolbar) === null || _k === void 0 ? void 0 : _k.set('fontSize', fontSize.toString());
            }
            else if (action === 'Bold') {
                const selectedCells = this.getSelectedCells();
                this.setCellsMutate(selectedCells, (cell) => {
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const value = ((_l = this.getCell(c.row, c.col)) === null || _l === void 0 ? void 0 : _l.bold) || false;
                (_m = this.toolbar) === null || _m === void 0 ? void 0 : _m.set('bold', value);
            }
                ...
                if ((c === null || c === void 0 ? void 0 : c.row) == null)
                    return;
                const value = ((_o = this.getCell(c.row, c.col)) === null || _o === void 0 ? void 0 : _o.italic) || false;
                (_p = this.toolbar) === null || _p === void 0 ? void 0 : _p.set('italic', value);
            }
                ...
                if (value === 'top') {
                    this.setCellsMutate(cells[0], (cell) => {
                        if (cell.fontSize == null) {
                    ...
                    this.setCellsMutate(cells[cells.length - 1], (cell) => {
                        if (cell.fontSize == null) {
    ...
    deleteRow(row = null, record = true) {
        var _a;
        row = row != null ? row : (_a = this.selectionStart) === null || _a === void 0 ? void 0 : _a.row;
        if (row == null)
            return;
    ...
    deleteCol(col = null, record = true) {
        var _a;
        col = col != null ? col : (_a = this.selectionStart) === null || _a === void 0 ? void 0 : _a.col;
        if (col == null)
            return;
    ...
    insertRow(row = null, data = null, record = true, heightOverride = null) {
        ...
        if (heightOverride != null)
            this.heightOverrides[row] = heightOverride;
        this.updateHeightAccum();
        this.rowNumbers.renderRowNumbers();
    ...
    insertCol(col = null, data = null, record = true, widthOverride = null) {
        ...
        if (widthOverride != null)
            this.widthOverrides[col] = widthOverride;
        this.updateWidthAccum();
        this.headerIdentifiers.renderHeaders();
    ...
    get totalRows() {
        var _a;
        return Math.max(((_a = this.data) === null || _a === void 0 ? void 0 : _a.bottomRow) || 0, this.blockRows) + (this.blockRows * this.padding);
    }
    get totalCols() {
        var _a;
        return Math.max(((_a = this.data) === null || _a === void 0 ? void 0 : _a.rightCol) || 0, this.blockCols) + (this.blockCols * this.padding);
    }
    startCellEdit(row, col, startingValue) {
        if (row < 0 || row > this.totalRowBounds || col < 0 || col > this.totalColBounds)
            return;
    ...
    getBoundingRectCells(startRow, startCol, endRow, endCol) {
        ...
        const merges = this.getMergesInRange({ startRow, startCol, endRow, endCol });
        if (merges.length === 0)
    ...
    mergeSelectedCells(bounds = null, recordChanges = true) {
        if (bounds == null && (!this.selectionStart || !this.selectionEnd))
            return;
    ...
    onSelectionChange() {
        ...
        const fontSize = ((_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a.fontSize) || '12';
        (_b = this.toolbar) === null || _b === void 0 ? void 0 : _b.set('fontSize', fontSize.toString());
        const fontFamily = this.getCell(row, col).ff || 'Arial';
        (_c = this.toolbar) === null || _c === void 0 ? void 0 : _c.set('fontFamily', fontFamily);
        const backgroundColor = this.getCell(row, col).bc || '#FFFFFF';
        (_d = this.toolbar) === null || _d === void 0 ? void 0 : _d.set('backgroundColor', backgroundColor);
        const textAlign = this.getCell(row, col).ta || 'left';
        (_e = this.toolbar) === null || _e === void 0 ? void 0 : _e.set('textAlign', textAlign);
        const bold = this.getCell(row, col).bold || false;
        (_f = this.toolbar) === null || _f === void 0 ? void 0 : _f.set('bold', bold);
        const italic = this.getCell(row, col).italic || false;
        (_g = this.toolbar) === null || _g === void 0 ? void 0 : _g.set('italic', italic);
        if (this.hasEvent('selectionChange')) {
            if (!this.prevSelectionBoundRect || (this.prevSelectionBoundRect.startRow !== this.selectionBoundRect.startRow ||
    ...
    updateSelection(fromKeyInput = false) {
        ...
        for (let col of this.selectedCols) {
            if (col < startCol || col > endCol) {
                ...
                if (handle)
                    handle.classList.remove('handle-col-selected');
            }
        }
        for (let i = startCol; i <= endCol; i++) {
            ...
            const handle = el.nextSibling;
            if (handle)
                handle.classList.add('handle-col-selected');
        }
        for (let row of this.selectedRows) {
            if (row < startRow || row > endRow) {
                ...
                const handle = el.nextSibling;
                if (handle)
                    handle.classList.remove('handle-row-selected');
            }
        }
        for (let i = startRow; i <= endRow; i++) {
            ...
            const handle = el.nextSibling;
            if (handle)
                handle.classList.add('handle-row-selected');
        }
    }
    positionSelectionHandle() {
        if (!this.selectedCell || !this.selectionHandle)
            return;
    ...
    get totalRowBounds() {
        var _a;
        let bounds = ((_a = this.heightAccum) === null || _a === void 0 ? void 0 : _a.length) || this.blockRows;
        if (this.maxRows)
            bounds = Math.min(bounds, this.maxRows - 1);
        return bounds;
    }
    get totalColBounds() {
        var _a;
        let bounds = ((_a = this.widthAccum) === null || _a === void 0 ? void 0 : _a.length) || this.blockCols;
        if (this.maxCols)
            bounds = Math.min(bounds, this.maxCols - 1);
        return bounds;
    }
    get totalYBounds() {
    ...
    updateWidthAccum() {
        ...
        for (let col = 0; col < oldWidth - 1 ||
            ...
            (updateVisWidth && col < (prevColBounds + this.blockCols)); col++) {
    ...
    getBorder(cell, side = 'left') {
        const border = cell === null || cell === void 0 ? void 0 : cell.border;
        ...
        if (typeof border === 'number' && hasBorderStr(border, side)) {
            let borderColor = cell === null || cell === void 0 ? void 0 : cell.borderColor;
    ...
    renderBorders(ctx, row, col, fromBlockRender) {
        ...
        if (leftBorder) {
            ...
            if ((_a = this.getCellOrMerge(cell.row, cell.col - 1)) === null || _a === void 0 ? void 0 : _a.bc) {
            }
            else {
        ...
        if (topBorder) {
            ...
            if ((_b = this.getCellOrMerge(cell.row - 1, cell.col)) === null || _b === void 0 ? void 0 : _b.bc) {
            }
            else {
                if (this.shouldDrawGridlines) {
                    this.setGridLineStroke(ctx);
        ...
        if (rightBorder) {
            ...
            if ((_c = this.getCellOrMerge(cell.row, cell.col + 1)) === null || _c === void 0 ? void 0 : _c.bc) {
            }
            else {
                if (this.shouldDrawGridlines) {
                    this.setGridLineStroke(ctx);
        ...
        if (bottomBorder) {
            ...
            if ((_d = this.getCellOrMerge(cell.row + 1, cell.col)) === null || _d === void 0 ? void 0 : _d.bc) {
            }
            else {
                if (this.shouldDrawGridlines) {
                    this.setGridLineStroke(ctx);
    ...
    getCtx(row, col) {
        ...
        if (!block)
            return;
        return block === null || block === void 0 ? void 0 : block.canvas.getContext('2d');
    }
    ...
    immediateRenderCell(row, col, fromBlockRender) {
        ...
        if (!block)
            return;
        let ctx = block === null || block === void 0 ? void 0 : block.canvas.getContext('2d');
        let left, top, width, height;
        ...
        if (this.getCell(row, col).cellType === 'button') {
            ...
            const lineChart = (_a = this.getLineChart(row, col)) === null || _a === void 0 ? void 0 : _a.el;
            ({ left, top, width, height } = this.metrics.getCellCoordsContainer(row, col));
            ...
            if ((_b = dependencyTree[row]) === null || _b === void 0 ? void 0 : _b[col]) {
    ...
    updateDim(row, col) {
        var _a, _b;
        if (!this.isNotMergedOver(row, col))
            return;
        if (!((_a = this.options) === null || _a === void 0 ? void 0 : _a.autosize))
            return;
        if (col in this.widthOverrides && !((_b = this.getCell(row, col)) === null || _b === void 0 ? void 0 : _b.ul))
            return;
    ...
    renderCell(row, col, fromBlockRender) {
        if (this.maxRows && row > this.maxRows || this.maxCols && col > this.maxCols)
            return;
    ...
    clearElRegistry(row, col) {
        ...
        if (this.elRegistry[_id]) {
            (_a = this.elRegistry[_id].el.parentNode) === null || _a === void 0 ? void 0 : _a.removeChild(this.elRegistry[_id].el);
        }
    }
    ...
    getCellId(row, col) {
        var _a;
        return (_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a._id;
    }
    ...
    getButton(row, col) {
        ...
        const cell = this.getCellOrMerge(row, col);
        if (cell.fontSize)
            button.style.fontSize = `${cell.fontSize}px`;
        if (cell.color)
            button.style.color = `${cell.color}`;
        button.style.userSelect = 'none';
    ...
    getCell(row, col) {
        if (!this.data)
            return { row, col };
        if (!this.data.has(row, col) || !this.data.get(row, col))
            return { row, col };
    ...
    getCellOrMerge(row, col) {
        const merge = this.getMerge(row, col);
        if (merge)
            return this.getCell(merge.startRow, merge.startCol);
        return this.getCell(row, col);
    }
    getCellText(row, col) {
        var _a;
        return ((_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a.text) || '';
    }
    getCellTextAlign(row, col) {
        var _a;
        return (_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a.ta;
    }
    // renderbackground
    renderCellBackground(ctx, row, col) {
        const cell = this.getCellOrMerge(row, col);
        if ((cell === null || cell === void 0 ? void 0 : cell.bc) != null) {
            ctx.save();
    ...
    setTextCtx(ctx, row, col) {
        ...
        if (((_a = this.getCell(cell.row, cell.col)) === null || _a === void 0 ? void 0 : _a.textBaseline) != null) {
    ...
    getFontSize(row, col) {
        var _a, _b;
        return (_b = (_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a.fontSize) !== null && _b !== void 0 ? _b : 12;
    }
    getCellColor(row, col) {
        var _a, _b;
        return (_b = (_a = this.getCell(row, col)) === null || _a === void 0 ? void 0 : _a.color) !== null && _b !== void 0 ? _b : '';
    }
