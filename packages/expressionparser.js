...
import { dependencyTree, reverseDependencyTree } from "./dependencytracker";
export default class ExpressionParser {
    ...
    addDependency(source, target) {
        ...
        if (!dependencyTree[tr])
            dependencyTree[tr] = {};
        if (!dependencyTree[tr][tc])
            dependencyTree[tr][tc] = {};
        if (!dependencyTree[tr][tc][sr])
            dependencyTree[tr][tc][sr] = {};
        dependencyTree[tr][tc][sr][sc] = true;
        if (!reverseDependencyTree[sr])
            reverseDependencyTree[sr] = {};
        if (!reverseDependencyTree[sr][sc])
            reverseDependencyTree[sr][sc] = {};
        if (!reverseDependencyTree[sr][sc][tr])
            reverseDependencyTree[sr][sc][tr] = {};
    ...
    getCellText(row, col) {
        var _a, _b;
        return (_b = (_a = this.data.get(row, col)) === null || _a === void 0 ? void 0 : _a.text) !== null && _b !== void 0 ? _b : '';
    }
