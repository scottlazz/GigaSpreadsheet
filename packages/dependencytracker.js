...
export function removeDependents(deptRow, deptCol) {
    ...
    for (const [drow, dcol] of dependencies) {
        const dcell = (_a = dependencyTree[drow]) === null || _a === void 0 ? void 0 : _a[dcol];
        if (!dcell)
            continue;
        if ((_b = dcell[deptRow]) === null || _b === void 0 ? void 0 : _b[deptCol]) {
...
export function getDependencies(row, col) {
    ...
    const cell = (_a = t[row]) === null || _a === void 0 ? void 0 : _a[col];
    if (!cell)
        return [];
...
export function removeDependencies(row, col) {
    var _a;
    const t = reverseDependencyTree;
    if (!((_a = t[row]) === null || _a === void 0 ? void 0 : _a[col]))
        return;
    delete t[row][col];
    if (isEmpty(t[row]))
        delete t[row];
